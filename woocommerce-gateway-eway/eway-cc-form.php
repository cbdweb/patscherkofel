...
<a href="<?php echo get_home_url(); ?>/checkout/" class="button" id="back-to-checkout" data-value="Back to Checkout">BACK TO CHECKOUT</a>
<input type="submit" value="<?php _e('Confirm and Pay', 'wc-eway'); ?>" class="submit buy button alt">
