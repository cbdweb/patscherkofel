...
<div class="timeline-holder">
	<div class="timeline">
		...
		<div id="step4" class="step active">4. <span>Payment</span></div>
	</div>
</div>
...
<div id="payment" class="woocommerce-checkout-payment">
	...
	<div class="form-row place-order">
		...
		<?php echo '<a href="'. get_home_url() .'/cart/" class="button" id="back-to-cart" data-value="Back to Your Bookings">BACK TO YOUR BOOKINGS</a>'; ?>
