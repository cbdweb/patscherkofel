...
<div class="cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">
	...
	<h2 class="booking-totals"><?php _e( 'Booking Totals', 'woocommerce' ); ?></h2>
	...
	<table cellspacing="0">
		...
		<?php foreach ( WC()->cart->get_coupons() as $code => $coupon ) : ?>
			<tr class="cart-discount coupon-<?php echo esc_attr( sanitize_title( $code ) ); ?>">
				...
				<td class="value"><?php wc_cart_totals_coupon_html( $coupon ); ?></td>
			</tr>
		<?php endforeach; ?>
		...
		<?php elseif ( WC()->cart->needs_shipping() ) : ?>
			...
			<tr class="shipping">
				...
				<td class="value"><?php woocommerce_shipping_calculator(); ?></td>
			</tr>
		...
		<?php if ( wc_tax_enabled() && WC()->cart->tax_display_cart == 'excl' ) : ?>
			...
			<?php else : ?>
				<tr class="tax-total">
					...
					<td class="value"><?php wc_cart_totals_taxes_total_html(); ?></td>
				</tr>
			<?php endif; ?>
		<?php endif; ?>
