					...
					<td class="product-remove">
						<?php
							echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
								'<a href="%s" class="remove-item" title="%s" data-product_id="%s" data-product_sku="%s"><span class="x">&times;</span> <span class="x-text">Remove</span></a>',
		...
		<tr>
			<td colspan="6" class="actions">
				...
				<form method="post">
					...
					<input type="submit" class="button" value="Clear All Bookings">
				</form>
